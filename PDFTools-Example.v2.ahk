...
; ║               set file/path vars                 ║
; ╚──────────────────────────────────────────────────╝
master_pdf_path     := A_ScriptDir  'U:\AHK Scripts\PDF Populate\templates\W9-MASTER.pdf'
master_xfdf_path    := A_ScriptDir  'U:\AHK Scripts\PDF Populate\templates\W9-MASTER.xfdf'
pdf_form_name       := 'W9'
output_dir          := A_Desktop    'U:\AHK Scripts\PDF Populate\templates' EXAMPLE_DATA.first_name ' ' EXAMPLE_DATA.last_name
temp_dir            := output_dir   'U:\AHK Scripts\PDF Populate\templates'
fn                  := EXAMPLE_DATA.first_name ' ' EXAMPLE_DATA.last_name ' - W9 ' A_YYYY '-' A_MM '-' A_DD
output_pdf_path     := output_dir   '\' 
temp_pdf_path       := temp_dir     '\'
temp_xfdf_path      := temp_dir     '\'
; ╔──────────────────────────────────────────────────╗
...
RunPDFTools(tool_id, input_pdf_path, output_pdf_path) {
    ...
    ; _________________________________________
    pdftools_path   := '"C:\Program Files\Tracker Software\PDF Editor\PDFXEdit.exe"'
